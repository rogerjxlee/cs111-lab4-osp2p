...
task_t *start_download(task_t *tracker_task, const char *filename)
{
  ...
  // EXERCISE 2A: Prevent overflow of the filename buffer by throwing an error
  //  when buffer overflow is detected and then exiting.
...
static void task_download(task_t *t, task_t *tracker_task)
{
  ...
  // EXERCISE 3: Evil mode will try to download the client peer code from 
  //  the seeder

  else
  	osp2p_writef(t->peer_fd, "GET  OSP2P\n");
